...
# -*- coding: utf-8 -*-
"""
Module d'Infiltration et Téléchargement Automatique pour RATISS v3.4 — Modèle Gilles High
Récupère à distance le modèle haute fidélité fr_FR-gilles-high depuis le dépôt officiel.
"""
...
TARGET_DIR = "./modeles"
FILES_TO_DOWNLOAD = {
    "fr_FR-gilles-high.onnx": "https://huggingface.co/rhasspy/piper-voices/resolve/v1.0.0/fr/fr_FR/gilles/high/fr_FR-gilles-high.onnx",
    "fr_FR-gilles-high.onnx.json": "https://huggingface.co/rhasspy/piper-voices/resolve/v1.0.0/fr/fr_FR/gilles/high/fr_FR-gilles-high.onnx.json"
}
...
if __name__ == "__main__":
    log.info("=== SÉQUENCE DE TÉLÉCHARGEMENT (Gilles-High) ===")
